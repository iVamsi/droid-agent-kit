...
- **`toolbox-core`** — shared primitives: `DroidAgentConfig`, `ProcessRunner`, `Redactor`, `ArtifactWriter`, `ToolResult`, user-policy merge (ADR 0002). Everything else depends on this.
