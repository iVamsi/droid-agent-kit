...
/**
 * Renders the two config documents. The project file holds only non-privileged settings;
 * grants (capabilities, opt-in tool groups) live in the user policy.
 */
object ConfigYaml {
    ...
    fun renderUserPolicy(
        ...
        lines += "# (see docs/security-and-permissions.md). Applies to every project this user opens."
