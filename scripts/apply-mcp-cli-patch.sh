...
git add cli/src/main/kotlin/com/droidagentkit/cli/DroidAgentMain.kt mcp-server/src/main/kotlin/com/droidagentkit/mcp/DroidAgentMcpDispatcher.kt gradle/verification-metadata.xml
